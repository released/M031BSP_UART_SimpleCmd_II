...
#line 45 "..\\project_config.h"
                                  
#line 54 "..\\project_config.h"
...
void stop_timer0(void)
{
    ...
    TIMER_DisableInt(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50000))); 
    TIMER_Stop(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50000)));        
}
...
void put_rc(uint8_t rc)
{
    ...
    const char *p =
        "error_head\0error_wrong_code\0error_wrong_data0\0error_wrong_data1\0error_wrong_data2\0error_wrong_data3\0"
        "error_cs\0error_tail\0error_timeout\0";
...
void fmt_err(uint8_t idx)
{
    ...
    uart_rcv_cnt = 0;
    ( ((0UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_uart_rx_rcv_timeout_10000ms))) : ((BitFlag&=~(uint32_t)(1<<flag_uart_rx_rcv_timeout_10000ms))));
    stop_timer0();
...
void fmt_parsing(void)
{
    ...
    if ((((BitFlag&(uint32_t)(1<<flag_uart_rx_rcv_ready))?1:0)))                        
    {
        if (RXBUFFER[fmt_head] != (0x5A) )               
        {
            fmt_err(error_head);
        }
        else
        {
            cal = CRC8(RXBUFFER, ((8) - 2 ));
            if (RXBUFFER[fmt_cs] != cal)                            
            {
               fmt_err(error_cs);  
            }
            else 
            {
                if (RXBUFFER[fmt_tail] != (0xA5))        
                {
                    fmt_err(error_tail);
                }
                else
                {
                    if ((RXBUFFER[fmt_code] == (0x01)) || 
                        (RXBUFFER[fmt_code] == (0x02)) || 
                        (RXBUFFER[fmt_code] == (0x03)) ||
                        (RXBUFFER[fmt_code] == (0x04)) )
                    {
                        ( ((0UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_uart_rx_rcv_timeout_10000ms))) : ((BitFlag&=~(uint32_t)(1<<flag_uart_rx_rcv_timeout_10000ms))));

                        printf("process OK !\r\n");

                        dump_buffer(RXBUFFER , (8));
                    }
                    else
                    {
        ...
        ( ((0UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_uart_rx_rcv_ready))) : ((BitFlag&=~(uint32_t)(1<<flag_uart_rx_rcv_ready)))); 
    }
}
...
{    
    ...
    {
        u32rcvtick = 0;
        ( ((1UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_uart_rx_rcv_timeout_10000ms))) : ((BitFlag&=~(uint32_t)(1<<flag_uart_rx_rcv_timeout_10000ms))));
        stop_timer0();
    }
    ...
    else if (uart_rcv_cnt ==  ((8)-1))
    {
        ...
        {
            RXBUFFER[uart_rcv_cnt] = c;
            ( ((1UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_uart_rx_rcv_ready))) : ((BitFlag&=~(uint32_t)(1<<flag_uart_rx_rcv_ready)))); 
            uart_rcv_cnt = 0;
            stop_timer0();
        }
    }    
...
{
    TIMER_Open(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50000)), (1UL << (27)), 10);
...
void TMR1_IRQHandler(void)
{
    ...
    if(TIMER_GetIntFlag(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50020))) == 1)
    {
		...
		if ((get_tick() % 1000) == 0)
		{
            ( ((1UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_timer_period_1000ms))) : ((BitFlag&=~(uint32_t)(1<<flag_timer_period_1000ms))));
		}          
...
void loop(void)
{
    ...
    if ((((BitFlag&(uint32_t)(1<<flag_uart_rx_rcv_timeout_10000ms))?1:0)))
    {
        ( ((0UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_uart_rx_rcv_timeout_10000ms))) : ((BitFlag&=~(uint32_t)(1<<flag_uart_rx_rcv_timeout_10000ms))));
    ...
    if ((((BitFlag&(uint32_t)(1<<flag_timer_period_1000ms))?1:0)))
    {
        ( ((0UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_timer_period_1000ms))) : ((BitFlag&=~(uint32_t)(1<<flag_timer_period_1000ms))));
...
void SYS_Init(void)
{
    ...
    ((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0140))->MODE &= ~((0x3ul << (4)) | (0x3ul << (6)));
